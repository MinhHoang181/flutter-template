...
class AppAppBarTheme extends AppBarTheme {
  AppAppBarTheme({required ColorScheme colorScheme, required TextTheme textTheme})
    : super(
        /// Căn giữa tiêu đề
        centerTitle: true,
...
extension AppAppBarThemeExtension on BuildContext {
  double get appBarHeight => Theme.of(this).appBarTheme.toolbarHeight ?? AppAppBarTheme.kToolbarHeight;
