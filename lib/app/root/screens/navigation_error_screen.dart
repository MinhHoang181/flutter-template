...
class NavigationErrorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppAppBar(title: context.text(LocaleKeys.core.error_screen.app_bar, defaultValue: 'Lỗi điều hướng')),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (onBackHome != null) ...[
                AppButton(
                  label: context.text(LocaleKeys.core.error_screen.back_home, defaultValue: 'Quay về trang chủ'),
                  onPressed: onBackHome != null ? () => onBackHome!(context) : null,
